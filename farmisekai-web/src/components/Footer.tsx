  ...
  return (
    <footer className="py-16 text-center bg-[#0a0a0a] text-stone-400 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 z-10 relative flex flex-col items-center">
        ...
        {/* โลโก้ทีม BigNi GameDev */}
        <div className="mb-8 hover:scale-105 transition-transform duration-300 cursor-pointer">
          <img 
            src={teamLogo} 
        ...
        {/* ชื่อเกมและคำอธิบาย */}
        <h3 className="text-xl md:text-2xl font-black text-amber-500 tracking-widest uppercase mb-4 drop-shadow-md">
          FarmIsekai
        </h3>
        ...
        {/* ปุ่ม Social Media ตรง Footer */}
        <div className="flex items-center gap-6 mb-10">
            {/* Facebook */}
            <a href="https://www.facebook.com/FarmIsekai" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-stone-900 border border-stone-800 flex items-center justify-center text-stone-400 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all hover:scale-110 shadow-lg">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@BigNiGameDev" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-stone-900 border border-stone-800 flex items-center justify-center text-stone-400 hover:text-white hover:bg-[#FF0000] hover:border-[#FF0000] transition-all hover:scale-110 shadow-lg">
        ...
        {/* ลิขสิทธิ์ */}
        <div className="w-full border-t border-white/5 pt-8 flex flex-col items-center gap-2">
            ...
            <p className="text-stone-700 text-[10px] mt-2">
